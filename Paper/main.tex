...
Finally, cross-validated means and standard deviations are used here as descriptive comparison statistics. We did not run fold-wise paired significance tests (e.g., Wilcoxon/Friedman/corrected paired tests), so inferential claims should be interpreted with caution.
